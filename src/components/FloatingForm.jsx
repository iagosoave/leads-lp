  ...
  return (
    <AnimatePresence>
      {isVisible && (
        ...
        >
          <motion.div
            className="w-full max-w-md mx-auto bg-slate-800 rounded-2xl shadow-2xl border border-amber-500/30 overflow-hidden relative"
          ...
          >
            ...
            <div className="p-5 sm:p-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
                ...
                <motion.button
                  type="submit"
                  className="w-full bg-amber-500 text-slate-900 py-2.5 sm:py-3 rounded-lg font-bold flex items-center justify-center text-sm sm:text-base"
              ...
              <div className="flex items-center justify-center mt-3 sm:mt-4">
                ...
                >
                  <div className="bg-green-500/20 text-green-500 px-2.5 sm:px-3 py-1 rounded-full text-xs font-medium flex items-center">
