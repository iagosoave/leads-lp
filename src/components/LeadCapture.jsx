...
export const LeadCapture = () => {
  const [formData, setFormData] = useState({
    name: '',
    email: '',
    phone: '' // Adicionando campo de telefone
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Simular um processamento (opcional)
      await new Promise(resolve => setTimeout(resolve, 1000));
      
      console.log('Iniciando download do arquivo...'); // Log para depuração
      
      // Iniciar o download do arquivo
      const downloadLink = document.createElement('a');
      downloadLink.href = ebookPDF; // Usar o PDF importado
      downloadLink.download = 'mentoria-metodoato-ebook.pdf'; // Nome do arquivo que será baixado
  ...
  return (
    <>
      ...
      {/* WhatsApp Community Section - Appears after successful download */}
      {formStatus.isSuccess && (
        <motion.div 
